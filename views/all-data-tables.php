            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-baseline justify-content-between mb-4">
                        ...
                        <?php if ( $jml_kp > 0 ): ?>
                            <a href="../application/report.php?id=<?= $alat[0]['id']?>"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                        <?php else: ?>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered nowrap" id="dataTable1" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th rowspan="2" >No</th>
                                    ...
                                    <?php foreach($kpl as $row) : ?>
                                        <tr>
                                            ...
                                            <?php foreach ($alat as $al) : ?>
                                                <td><?= $row['jumlah_'.$al['alat_id']]; ?></td>
                                                <td><?= $row['kondisi_'.$al['alat_id']]; ?></td>
                                                <td><?= $row['merk_'.$al['alat_id']]; ?></td>
                                            <?php endforeach; ?>  
                                            <?php if (!empty($_SESSION['admin'])) {?>          
